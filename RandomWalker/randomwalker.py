...
class RandomWalker:
    ...
    async def walk(self, dag, prev_tips, current_batch_transactions): # previous tips added to insure parallel behaviour
        ...
        while len(reached_tips) < 2:
            ...
            path_to_tip = await self.compute_path_to_tip(dag, random_tip, self.W)
            print("RANDOM REACHED TIP PATH",path_to_tip)
            tip_paths[random_tip.txid] = [path_to_tip]
            reached_tips.append(random_tip)
